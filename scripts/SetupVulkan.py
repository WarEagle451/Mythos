...
class VulkanConfiguration:
    ...
    vulkanDirectory = "Mythos/vendor/VulkanSDK" #Installer download location, should probs go into the os's temp dir
    ...
    def CheckVulkanSDK(cls):
        ...
        if (cls.requiredVulkanVersion not in vulkanSDK):
            print(f"You don't have the correct Vulkan SDK version! (Mythos requires {cls.requiredVulkanVersion})")
            cls.__InstallVulkanSDK()
            return False
