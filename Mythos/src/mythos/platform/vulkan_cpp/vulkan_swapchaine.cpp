...
namespace myl::vulkane {
	...
	void swapchain::create_render_pass() {
		m_render_pass = std::make_unique<vulkane::render_pass>(*this, m_context, 0.f, 0.f, static_cast<f32>(m_swapchain_extent.width), static_cast<f32>(m_swapchain_extent.height), f32vec4{ .5f, .5f, .5f, 1.f }, 1.f, 0); /// MYTodo: This is a temp clear color
	}
