...
#	define MYL_VK_CHECK(func, ...) { const VkResult y7tp = func(__VA_ARGS__); MYL_CORE_ASSERT(y7tp == VK_SUCCESS, std::format("Vulkan - '{}' failed. Result: {}", #func, myl::vulkane::VkResult_to_string(y7tp))); }
#else
