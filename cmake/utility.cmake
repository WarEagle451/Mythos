...
function(get_build_type_nickname OUT_NAME)
    set(${OUT_NAME} "$<$<CONFIG:Debug>:debug>$<$<CONFIG:Release>:release>$<$<CONFIG:RelWithDebInfo>:dev>$<$<CONFIG:MinSizeRel>:tiny>" PARENT_SCOPE)
    if ("${OUT_NAME}" STREQUAL "")
        message(WARNING "Custom build-type defined, unable to determine build type nickname. Setting to an empty string.")
    endif()
endfunction(get_build_type_nickname)